...
> The code below shows the `read_csv` function and runs it so you can see the data. Don't add this to your notebook, just run it here on the site.
...
We've put together [some exercises to practice](https://github.com/utdata/chj-r-introduction/blob/main/students/day1-p2-practice.md) importing and exporting data. They will build on each other each day.
