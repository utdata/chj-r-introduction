...
```{r download}
download.file("https://github.com/utdata/chj-r-introduction/raw/main/students/chj-practice/data-raw/maritime-redacted.xlsx", "data-raw/maritime.xlsx", mode = "wb")
```
