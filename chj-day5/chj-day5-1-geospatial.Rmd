---
title: '1: Geospatial introduction
...
```{r tigris_map_custom, warning=F, message=F, quietly=T, echo=T, results='hide'}
...
```{r unemployed_new_county, warning=F, message=F}
jobs <- c(labor_force = "B23025_005E", 
              unemployed = "B23025_002E")
...
```{r facet2, warning=F, message=F, quietly=T, echo=T, results='hide'}
racevars <- c(White = "B03002_003", 
              Black = "B03002_004", 
              Asian = "B03002_006",
              Hispanic = "B03002_012")
