...
This first session on the first day we'll be learning about RStudio, RMarkdown and how to use them. It's a lot of setup and not a lot of practice. I promise we'll get to the data quickly in future sessions.
