...
- When you run the code chunk, you get the result of the math equation below it, `[1] 96` in my case. That means there was one observation, and the value was "92". For the record, my wife is _much_ younger than that.
...
4. Go to <a href="https://github.com/utdata/chj-r-introduction/blob/main/students/day1-p2-practice.md" target="_blank">this link</a> in your browser.
